...
```javascript
incrSGDRegression = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ml-incr-sgd-regression@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/ml-incr-sgd-regression@umd/bundle.js"></script>
```
